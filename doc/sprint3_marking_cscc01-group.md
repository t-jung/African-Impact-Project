...
## Planning Meetings (SR(N-1).md, sprintN.md) (max 2 marks)
  ...
  - SR(N-1).md (Sprint Retrospective) (max 2 marks)
    ...
    > Best/Worst experience during Sprint 2: This course. Burning hours of time researching information that is not taught in course material.
    🤨
...
## Daily Stand-ups (max 10 marks)
  ...
  Two messages late for Standup 1:
  https://discordapp.com/channels/831523030748233799/845732679395704832/863792668088860682
  https://discordapp.com/channels/831523030748233799/845732679395704832/863968532831272971
...
## User Stories (Tracked in Jira) (max 10 marks) 
  - Correctly formulated user stories (max 2 marks)
    ...
    Your Mark: 1
    https://mcsapps.utm.utoronto.ca/jira/browse/CSCCPROJ-4 missing so that clause
    https://mcsapps.utm.utoronto.ca/jira/browse/CSCCPROJ-93
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    https://github.com/UTSCCSCC01/project-cscc01-group/pull/31/commits
    https://github.com/UTSCCSCC01/project-cscc01-group/pull/29/commits
    https://github.com/UTSCCSCC01/project-cscc01-group/pull/28/commits
    https://github.com/UTSCCSCC01/project-cscc01-group/pull/26/commits
...
## Sprint Demo (Max 10 marks) 
 ...
 - Uploading videos to database
 - Viewing videos
 - Writing and commenting on post

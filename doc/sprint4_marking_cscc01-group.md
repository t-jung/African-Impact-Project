...
## User Stories (Tracked in Jira) (max 10 marks) 
  - Correctly formulated user stories (max 2 marks)
    ...
    Your Mark: 1
    CSCCPROJ-70, CSCCPROJ-102, CSCCPROJ-136 did not follow story format
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 0 Stories do not have acceptance criteria
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Jira Active Sprint Board? (max 2 marks)
    ...
    CSCCPROJ-23 does not have corresponding pull request, no mark was deducted
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 0
    Majority of commit message do not begin with the ticket number
  ...
  - Tasks Distribution (max 3 marks)
    ...
    Your Mark: 1 
    CSCCPROJ-18 and CSCCPROJ-22 are not completed without pull requests
